export default {
  list: {
    ...
    ingress_match: "Ingress Match",
    ingress: "Ingress Rules",
    egress: "Egress Targets",
    dns: "DNS Rules",
    target_ip: "Target IP Rules",
    actions: "Actions",
    remark: "Remark",
    no_dns_rules: "No DNS rules",
    no_target_ip_rules: "No target IP rules",
    match_items: "{count} match item(s)",
    priority: "Priority: {priority}",
    uses_dns: "queries via DNS",
    request: "",
    egress_label: "Egress:",
    all_domains: "All domains",
    all_target_ips: "All destination IPs",
    unknown_upstream: "Unknown DNS upstream",
    edit_default_rules: "Edit Default Rules",
  },
  default_card: {
    title: "Default Flow",
